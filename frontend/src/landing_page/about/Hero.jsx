    ...
    return ( 
        <div className="container-fluid mt-5 pt-5">
            <div className="row text-center mb-2 mb-lg-5">
                <h1 className="fs-4 text-muted my-5">We pioneered the discount broking model in India. <br />Now, we are breaking ground with our technology.</h1>
            </div>
            <div className="row m-lg-5 p-lg-5 m-2 p-2 border-top">
