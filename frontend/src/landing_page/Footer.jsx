...
function Footer() {
return (
<div className="container border-top mt-5 py-5 pb-0">
    <div className="row footer">
        <div className="col-lg-4 col-12">
            <img src="images/logo.svg" alt="logo" width="140" height="20" />
            <p className="mt-4">© 2010 - 2025, Zerodha Broking Ltd. All rights reserved.</p>
            <div className="pb-3 footer-icon">
        ...
        <div className="col-lg-2 col-6">
            <h1 className="fs-5 opacity-75 mt-lg-0 mt-4">Account</h1>
        ...
        <div className="col-lg-2 col-6">
            <h1 className="fs-5 opacity-75 mt-lg-0 mt-4">Support</h1>
            <ul className="list-unstyled">
        ...
        <div className="col-lg-2 col-6">
            <h1 className="fs-5 opacity-75 mt-lg-0 mt-4">Company</h1>
            <ul className="list-unstyled">
        ...
        <div className="col-lg-2 col-6">
            <h1 className="fs-5 opacity-75 mt-lg-0 mt-4">Quick links</h1>
            <ul className="list-unstyled">
        ...
        <div className="footer-content text-muted">
            <p className="mt-5 mb-0">
                ...
                Depository
                services through Zerodha Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address:
                Zerodha
                ...
                to
                <a href="#">complaints@zerodha.com</a>, for DP related to <a href="#">dp@zerodha.com</a>.
            ...
            <p><a href="#">Smart Online Dispute Resolution</a> | <a href="#">Grievances Redressal
                    Mechanism</a></p>
            ...
            <p>Attention investors: 1) Stock brokers can accept securities as margins from clients only by way of pledge
                in
                the depository system w.e.f September 01, 2020. 2) Update your e-mail and phone number with your stock
            ...
            <p>"Prevent unauthorised transactions in your account. Update your mobile numbers/email IDs with your stock
                ...
                of
                the day. Issued in the interest of investors. KYC is one time exercise while dealing in securities
                markets -
                once KYC is done through a SEBI registered intermediary (broker, DP, Mutual Fund etc.), you need not
                undergo
                the same process again when you approach another intermediary." Dear Investor, if you are subscribing to
                an
                IPO, there is no need to issue a cheque. Please write the Bank account number and sign the IPO
                application
                form to authorize your bank to make payment in case of allotment. In case of non allotment the funds
                will
                remain in your bank account. As a business we don't give stock tips, and have not authorized anyone to
                trade
                on behalf of others. If you find anyone claiming to be part of Zerodha and offering such services,
                please <a href="#">create a ticket here.</a></p>

            <p> *Customers availing insurance advisory services offered by Ditto (Tacterial Consulting Private Limited |
                IRDAI Registered Corporate Agent (Composite) License No CA0738) will not have access to the exchange
                investor grievance redressal forum, SEBI SCORES/ODR, or arbitration mechanism for such products.</p>
        </div>
        <div className="footer-last text-center fs-6 mb-3">
            <a href="#">NSE</a>
            <a href="#">BSE</a>
            <a href="#">MCX</a>
