...
<div className="container p-lg-5">
    <div className="row charges-explain p-lg-5">
        <h1 className="fs-4 mt-5">Charges explained</h1>
        <div className="col-12 col-md-6 pe-md-5">
            <div>
                <h6>Securities/Commodities transaction tax</h6>
                <p>Tax by the government when transacting on the exchanges. Charged as above on both buy and sell sides
                    when trading equity delivery. Charged only on selling side when trading intraday or on F&O.</p>
                <p>When trading at Zerodha, STT/CTT can be a lot more than the brokerage we charge. Important to keep a
                    tab.</p>
            </div>
            <div>
